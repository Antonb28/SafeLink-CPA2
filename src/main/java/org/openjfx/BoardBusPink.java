...
public class BoardBusPink {
    ObservableList<String> currentStationList = FXCollections.observableArrayList("Ayala","BGC","Bicutan","Sucat","Alabang");
    ObservableList<String> destinationStationList = FXCollections.observableArrayList("Ayala","BGC","Bicutan","Sucat","Alabang");
